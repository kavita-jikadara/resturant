...
import 'package:admin_panel/order/acporder.dart';
import 'package:admin_panel/order/pandngorder.dart';
import 'package:admin_panel/order/rejectorder.dart';
...
class _orderState extends State<order> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    tabs = TabController(length: 3, vsync: this,initialIndex: 0);
    super.initState();
